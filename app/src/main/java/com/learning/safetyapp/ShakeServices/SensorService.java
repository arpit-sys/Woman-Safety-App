package com.learning.safetyapp.ShakeServices;
...
import com.learning.safetyapp.Contacts.ContactModel;
import com.learning.safetyapp.Contacts.DbHelper;
import com.learning.safetyapp.MainActivity;
...
public class SensorService extends Service {
    ...
    public void onCreate() {
        ...
        mShakeDetector.setOnShakeListener(new ShakeDetector.OnShakeListener() {
            ...
            public void onShake(int count) {
                //check if the user has shaken the phone for 3 times in a row
                if (count == 3) {
                    //vibrate the phone
                    vibrate();
    ...
    * implemented strict notification rules, which requires us to identify
    * our own notification channel in order to view them correctly.
    */

    @RequiresApi(Build.VERSION_CODES.O)
    private void startMyOwnForeground(){
        String NOTIFICATION_CHANNEL_ID = "example.performance";
        ...
        Notification notification = notificationBuilder.setOngoing(true)
                .setContentTitle("You are Protected").setContentText("We are there for you")
                .setSmallIcon(R.drawable.ic_launcher_foreground).setPriority(NotificationManager.IMPORTANCE_MAX)
    ...
    public void onDestroy() {
        ...
        // create an Intent to call Broadcast receiver
