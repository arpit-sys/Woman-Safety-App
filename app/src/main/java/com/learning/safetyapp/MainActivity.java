package com.learning.safetyapp;
...
import com.learning.safetyapp.Contacts.CustomAdapter;
import com.learning.safetyapp.Contacts.DbHelper;
import com.learning.safetyapp.ShakeServices.ReactivateService;
import com.learning.safetyapp.ShakeServices.SensorService;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){
            if (ActivityCompat.checkSelfPermission
                    (this, Manifest.permission.ACCESS_COARSE_LOCATION)==PackageManager.PERMISSION_DENIED){
    ...
    //this method prompts the user to remove any battery optimisation from the App
